...
import {  Building2, Users, BarChart3, Settings, X ,LayoutDashboard} from "lucide-react";
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Single Sidebar Component - NO SCROLL */}
      <motion.div
      ...
      >
        <div className="p-5  border-b border-gray-200 shrink-0">
          <div className="flex items-center justify-between">
            <div className="pt-1">
              <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#F5C857]"
              style={{
        ...
        <div className="p-6 border-t border-gray-200 flex justify-start">
          <button className="flex items-center justify-center gap-2 text-red-600 hover:text-red-700 font-medium text-sm">
